...
type Props = { delay?: number | undefined; formik: { [key: string]: any } };

const AutoSave = ({ delay = 400, formik }: Props) => {
	...
	const onFormSubmit = useCallback(async () => {
		...
		if (submitForm && !isSameValueAsInitialValue(v, initialValues)) submitForm(v);
